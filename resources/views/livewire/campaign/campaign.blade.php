...
<div>
    <div class="col-md-6">
        ...
        @if ($updateCampaign)
            <div class="fixed">
                <div id="modal_edit_campaign" wire:ignore.self aria-hidden="true"
                    ...
                    <div class="relative px-4 w-full h-full md:h-auto">
                        <div class="relative w-5/12 mx-auto bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                ...
                                <div class="mt-10">
                                    <button wire:click="update()" onclick="edit_campaign()"
                                    ...
                                    <button data-modal-toggle="defaultModal" type="button" onclick="edit_campaign()"
        ...
        @endif
        <div>
            @include('livewire.campaign.create')
        </div>
            ...
            <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 mx-auto">
                    <div class="rounded-lg mx-auto">
                        <button onclick="create_campaign()"
                        ...
                        <table class="w-full py-4" id="campain_table">
                            ...
                            <tbody>
                                @foreach ($data_campaign as $campaign)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap" wire:key="{{ $loop->index }}">
                                            <button wire:click="edit({{ $campaign->id }})" onclick="edit_campaign()"
...
<script>
    $(document).ready(function() {
        $('#campain_table').dataTable();
    });
    function edit_campaign() {
        document.getElementById('modal_edit_campaign').classList.toggle('hidden');
    }

    function create_campaign() {
        document.getElementById('modal_create_campaign').classList.toggle('hidden');
    }
</script>
